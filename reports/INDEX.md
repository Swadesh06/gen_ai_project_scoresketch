...
| exp_B2_vocadito_sweep | 2026-05-02 | Vocadito F1 0.538 → **0.577** | keep | Bayesian sweep tunes soft-mode defaults. |
| exp_B3_crepe_vs_pesto | 2026-05-02 | PESTO 0.576 vs CREPE 0.562 | discard | -1.4pp aggregate. |
| exp_B4_hmm_segmenter | 2026-05-02 | HMM 0.518 vs voicing 0.538 | discard | Default config worse. |
...
| exp_B10_onset_bilstm | 2026-05-02 | 0.490 (best τ) | discard | Train set too small. |
...
| exp_B14_maestro_instrument | 2026-05-02 | mean F1 = **0.984** | keep | Pipeline saturated on MAESTRO. |
...
| exp_B17_pitch_ensemble | 2026-05-02 | 0.553 vs PESTO 0.576 | discard | Per-frame max-conf hurts. |
| exp_B18_verovio_svg | 2026-05-02 | qualitative | keep | Real notation SVGs via Verovio (5KB pianoroll → 121KB engraving). |
