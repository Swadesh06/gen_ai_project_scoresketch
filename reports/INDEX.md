...
| exp_B5_tempo_adaptive_tpb | 2026-05-02 | ASAP snap 0.719 → **0.740** | keep | TPB=24 default, +2.1pp on snap. |
| exp_B6_hmm_sweep | 2026-05-02 | HMM-tuned 0.544 vs voicing 0.577 | discard | HMM ceiling 0.033 below voicing+tune. |
...
| exp_B10_onset_bilstm | 2026-05-02 | 0.490 (best τ=0.6) | discard | Trained on 30 Vocadito clips. Loses to voicing baseline by 8pp. |
| exp_B11_voicing_hmm_ensemble | 2026-05-02 | union 0.568 vs voicing 0.576 | discard | Errors are correlated; ensemble no help. |
| exp_B12_asap_multi | 2026-05-02 | mean snap 0.773 across 5 pieces | keep | B1 + B5 wins generalize. Stage 5 5/5 pass 60%. |
| exp_B13_tempo_octave | 2026-05-02 | mean Stage-4 0.836 → **0.897** | keep | beat_this(target_bpm=) octave-snap. +6pp mean, +23pp on bwv_857. |
| exp_B14_maestro_instrument | 2026-05-02 | mean F1 = **0.984** | keep | Full instrument pipeline on 5 MAESTRO clips. ByteDance + DP at saturation. |
